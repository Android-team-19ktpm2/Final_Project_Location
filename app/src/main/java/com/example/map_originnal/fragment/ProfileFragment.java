...
/*        edt_email = layout_user.findViewById(R.id.profile_edt_email);*/
            ...
            FirebaseDatabase.getInstance().getReference("Users").child(firebaseUser.getUid()).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (current_user.getAvatar().equals("default"))
                        ...
                        Glide.with(getActivity()).load(current_user.getAvatar()).into(avatar);
                }
        ...
        /*//edit email
        btn_pencil_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //invisible
                tv_email.setVisibility((View.INVISIBLE));
                btn_pencil_email.setVisibility(View.INVISIBLE);

                //visible
                edt_email.setVisibility(View.VISIBLE);
                btn_check_email.setVisibility(View.VISIBLE);

                //set current value
                edt_email.setText(tv_email.getText().toString());
            }
        });
        ...
        btn_check_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String new_val = edt_email.getText().toString();
                ...
                btn_check_email.setVisibility(View.INVISIBLE);

                //visible
                tv_email.setVisibility((View.VISIBLE));
                btn_pencil_email.setVisibility(View.VISIBLE);

                //update
                update("email", new_val);
            }
        });*/
