            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    for(DataSnapshot ds: snapshot.getChildren()){
                        ...
                        //                                ,ds.child("avatar").getValue(String.class)
                        //                                ,ds.child("first_name").getValue(String.class)
                        //                                ,ds.child("last_name").getValue(String.class)
                        //                                ,ds.child("online").getValue(String.class)
